...
The UMD `main` bundle (as used by jsdelivr [CDN](#cdn)) supports the last 3 major versions of iOS Safari and the last 2 major versions of: Chrome, Safari, Edge, Firefox, Android Chrome and Samsung Internet.
